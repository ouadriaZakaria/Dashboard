  ...
  return (
    <main className="w-full pb-24 lg:pb-3 bg-gray-50 p-2 md:p-5 overflow-y-auto h-full ">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Total Revenue Card */}
        <div className="lg:col-span-2 relative h-[440px] bg-white rounded-xl shadow-sm border border-gray-200 p-4">
        ...
        <div className="space-y-6">
          {/* Total Orders */}
          <div className="bg-white rounded-xl lg:h-[207px] shadow-sm border border-gray-200 p-2 lg:p-6">
            ...
            <div className="flex flex-col lg:flex-row  lg:items-end justify-between">
              ...
              {orders.chartData && (
                <div className="h-16 w-full lg:w-32">
          ...
          <div className="bg-white rounded-xl lg:h-[207px] shadow-sm border border-gray-200 p-2 lg:p-6">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between">
              ...
              {profit.chartData && (
                <div className="h-18 w-full lg:w-32">
      ...
      {/* Sessions Card */}
      <div className="mt-6">
        <div className="bg-white rounded-xl  shadow-sm border border-gray-200 p-2 lg:p-6 max-w-md">
          <div className="mb-4">
